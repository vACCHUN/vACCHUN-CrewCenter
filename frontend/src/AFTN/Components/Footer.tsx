    ...
    <div className="w-full bg-white">
      <div className="bg-white px-3 text-sm flex justify-between w-[90%]">
        <div className="flex items-center">
          <input disabled type="checkbox" id="taviratJelzese" className="mr-1" />
          <label htmlFor="taviratJelzese" className="mr-2 font-bold">
            {" "}
            Új távirat jelzése
          </label>
          <input disabled type="checkbox" id="listaElejere" className="ml-3 mr-1" />
          <label htmlFor="listaElejere" className="mr-2 font-bold">
            {" "}
            Auto. lista elejére
          </label>
          <input disabled type="checkbox" id="autoTorles" className="ml-3 mr-1" />
