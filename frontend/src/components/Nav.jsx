...
function Nav(props) {
    return (
        <>
            <div className='bg-white flex fixed top-0 left-0 w-[100%] items-center drop-shadow-lg'>
                ...
                <Link to='/'><i className={`fa-solid fa-bug ${props.Active === 'bug' ? 'text-blue-500' : 'text-awesomecolor'}`}></i></Link>
                    ...
                    <Link to='/admin'><i className={`fa-solid fa-bulldozer ${props.Active === 'bulldozer' ? 'text-blue-500' : 'text-awesomecolor'}`}></i></Link></div>
