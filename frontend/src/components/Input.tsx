...
const Input = forwardRef<HTMLInputElement, InputProps>(function TimeInput({ type = "text", placeholder, defaultValue = "", min, max, onChange, nextRef, className = "" }: InputProps, ref) {
